...
import { ChevronDown, Github, Linkedin, Mail, ExternalLink, Code, Palette, Smartphone, Menu } from 'lucide-react';
import MatrixRevealText from '../Components/MatrixRevealText';
...
const Portfolio = () => {
  ...
  const projects = [
    ...
    {
      title: "Weather App",
      description: "A responsive weather application with location-based forecasts, interactive maps, and beautiful UI animations.",
  ...
  const skills = [
    { name: "Frontend Development", icon: Code, description: "React, JavaScript, HTML5, CSS3" },
    { name: "UI/UX Design", icon: Palette, description: "Figma, Adobe Illustrator, Responsive Design" },
    {name: "Backend Development", icon: Smartphone, description: "Node.js, Express, MongoDB, REST APIs" },
    { name: "Version Control", icon: Github, description: "Git, GitHub, Version Control Systems" },
    { name: "Deployment", icon: ExternalLink, description: "Heroku, Netlify, Vercel, Railway"}
  ];
  ...
  return (
    <div className="bg-gradient-to-br from-slate-900 via-slate-800 to-neutral-900 text-white overflow-x-hidden">
              ...
              {['home', 'about', 'skills', 'projects', 'contact'].map((section) => (
                <button
                  ...
                  className={`capitalize transition-all duration-300 hover:text-orange-400 ${
                    activeSection === section ? 'text-orange-400' : 'text-gray-300'
                  }`}
                >
                  {section}
                </button>
      ...
      {/* Hero Section */}
      <section id="home" className="min-h-screen flex items-center justify-center relative pt-24 sm:pt-28">
        ...
        <div className="container mx-auto px-4 sm:px-6">
          <div 
            ...
            className={`text-center mb-10 sm:mb-16 transition-all duration-800 ease-out ${
              isVisible['about-title'] ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'
            }`}
          >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 sm:gap-12 items-center">
            <div 
              ...
              id="about-text"
              className={`transition-all duration-1000 ease-out ${
                isVisible['about-text'] ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-12'
              }`}
            ...
            >
              ...
              <p className="text-gray-300 mb-4 sm:mb-6 leading-relaxed text-base sm:text-lg">
                I'm a creative problem solver who loves turning complex challenges into simple, 
                beautiful solutions. My journey in web development started with curiosity and 
                has evolved into a passion for creating meaningful digital experiences.
              </p>
              <p className="text-gray-300 mb-6 sm:mb-8 leading-relaxed text-base sm:text-lg">
                When I'm not coding, you can find me exploring new technologies, contributing 
                to open-source projects, or mentoring aspiring developers in my community. Click on the links below to connect with me on GitHub, LinkedIn, or send me an email. or You can also send me your details in the contact form at the end.
              </p>
              <div className="flex space-x-4">
                <a href="https://github.com/azhank391" className="text-orange-400 hover:text-orange-300 transition-colors">
                  <Github className="w-6 h-6" />
                </a>
                <a href="https://www.linkedin.com/in/muhammad-azhan-74931b250/" className="text-orange-400 hover:text-orange-300 transition-colors">
                  <Linkedin className="w-6 h-6" />
                </a>
                <a href="mailto:azhanakhtarcaia@gmail.com" className="text-orange-400 hover:text-orange-300 transition-colors">
            ...
            <div 
              ...
              id="skills-grid"
              className={`transition-all duration-1000 ease-out ${
                isVisible['skills-grid'] ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-12'
              }`}
                ...
                {skills.map((skill, index) => (
                  ...
                  >
                    <div className="flex items-center mb-2 sm:mb-3">
                      ...
                      <h4 className="text-lg sm:text-xl font-semibold text-orange-300">{skill.name}</h4>
                    </div>
      ...
      <section id="skills" className="py-16 sm:py-20">
        <div className="container mx-auto px-4 sm:px-6">
          <div 
            ...
            id="skills-title"
            className={`text-center mb-10 sm:mb-16 transition-all duration-800 ease-out ${
              isVisible['skills-title'] ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'
            }`}
          >
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-4 bg-gradient-to-r from-orange-400 to-amber-300 bg-clip-text text-transparent">
              Skills & Technologies
  ...
  {Object.entries(techStack).map(([category, technologies], categoryIndex) => (
    <div
      ...
      className={`transition-all duration-800 ease-out ${
        isVisible[`tech-category-${categoryIndex}`] ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'
      }`}
        ...
        {technologies.map((tech, techIndex) => (
          <div
            ...
            className={`bg-gradient-to-br from-slate-800 to-slate-700 p-4 sm:p-6 rounded-xl border border-orange-500/20 hover:border-orange-400/40 transition-all duration-500 hover:transform hover:scale-105 hover:shadow-lg hover:shadow-orange-500/20 text-center group ${
              isVisible[`tech-category-${categoryIndex}`] ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
            }`}
            style={{ transitionDelay: `${categoryIndex * 150 + techIndex * 50}ms` }}
          >
            ...
            {projects.map((project, index) => (
              <div 
                ...
                className={`bg-gradient-to-br from-slate-800 to-slate-700 rounded-xl overflow-hidden border border-orange-500/20 hover:border-orange-400/40 transition-all duration-600 hover:transform hover:scale-105 hover:shadow-xl hover:shadow-orange-500/20 ${
                  isVisible[`project-${index}`] ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'
                }`}
              ...
              >
                ...
                <div className="p-4 sm:p-6">
                  <h3 className="text-lg sm:text-xl font-semibold mb-2 sm:mb-3 text-orange-300">{project.title}</h3>
                  <p className="text-gray-400 mb-3 sm:mb-4 text-xs sm:text-sm leading-relaxed">{project.description}</p>
                  <div className="flex flex-wrap gap-2 mb-3 sm:mb-4">
                    {project.technologies.map((tech) => (
                      <span key={tech} className="bg-orange-600/20 text-orange-300 px-2 sm:px-3 py-1 rounded-full text-xs">
                        {tech}
                      </span>
                    ))}
                  </div>
          ...
          <div className="max-w-4xl mx-auto">
            <div 
              ...
              className={`text-center mb-8 sm:mb-12 transition-all duration-800 ease-out ${
                isVisible['contact-content'] ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'
              }`}
              style={{ transitionDelay: '200ms' }}
            >
            ...
            <div 
              ...
              className={`grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 transition-all duration-800 ease-out ${
                isVisible['contact-form'] ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'
              }`}
              style={{ transitionDelay: '400ms' }}
            >
              <div className="space-y-4 sm:space-y-6">
                <div className="bg-gradient-to-r from-slate-800 to-slate-700 p-4 sm:p-6 rounded-xl border border-orange-500/20">
                  <h3 className="text-lg sm:text-xl font-semibold mb-2 sm:mb-4 text-orange-300">Get In Touch</h3>
                  <div className="space-y-3 sm:space-y-4">
                    <div className="flex items-center">
                      <Mail className="w-5 h-5 text-orange-400 mr-3" />
                      <a href="mailto:azhanakhtarcaia@gmail.com" className="text-gray-300 text-xs sm:text-base">azhanakhtarcaia@gmail.com</a>
                    </div>
                    <div className="flex items-center">
                      <Github className="w-5 h-5 text-orange-400 mr-3" />
                      <a className="text-gray-300 text-xs sm:text-base">https://github.com/azhank391</a>
                    </div>
                    <div className="flex items-center">
                      <Linkedin className="w-5 h-5 text-orange-400 mr-3" />
                      <a className="text-gray-300 text-xs sm:text-base">https://www.linkedin.com/in/muhammad-azhan-74931b250/</a>
                    </div>
                  </div>
                </div>
              </div>

              <form id='contact-form' onSubmit={handleSubmit} className="space-y-3 sm:space-y-4">
                <input
                  type="text"
                  name='name'
                  value={formData.name}
